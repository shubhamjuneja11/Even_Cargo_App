 ...
 */
public  class DoneFirebaseListAdapter<T> extends BaseAdapter {
    ...
    public DoneFirebaseListAdapter(Query mRef, Class<T> mModelClass, int mLayout, Activity activity) {
        this.mRef = mRef;
...
Log.e("is added","");
                ...
                T model = dataSnapshot.getValue(DoneFirebaseListAdapter.this.mModelClass);
                OrderClass orderClass=(OrderClass)model;
                if(orderClass.getdriver().equals(SigninActivity.myemail)&&(orderClass.getstatus()==4||orderClass.getstatus()==5||orderClass.getstatus()==6)&&orderClass.getD()==1) {
            ...
            public void onChildChanged(DataSnapshot dataSnapshot, String s) {
               ...
               String key = dataSnapshot.getKey();
                T newModel = dataSnapshot.getValue(DoneFirebaseListAdapter.this.mModelClass);
                OrderClass orderClass=(OrderClass)newModel;
                if(orderClass.getmanager().equals(SigninActivity.myemail)&&(orderClass.getstatus() == 4 || orderClass.getstatus() == 5||orderClass.getstatus()==6)&&orderClass.getD()==0) {

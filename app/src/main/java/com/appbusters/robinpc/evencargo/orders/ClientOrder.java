...
public class ClientOrder extends AppCompatActivity {
    ...
    TextView clientname;
    Firebase firebase;
    TextView t1,t3,t4,t5,t6,t7,t8,t9,t10;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId()==R.id.save)
        {
            ...
            if(manager.equals("Manager")||pdate.equals("Date")||ptime.equals("Time")||paddress.equals("Pickup Address")||daddress.equals("Delivery Address")||packagedetails.equals("Package Detials"))
                ...
                OrderClass neworder = new OrderClass(manager, driver, client, pdate, ptime, paddress, paddressdetails, daddress, daddressdetails, packagedetails,0,orderno,1,1,0);
                ...
                finish();
                Toast.makeText(ClientOrder.this,"Order placed",Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       clientname.setText(SigninActivity.myemail);
        f1=new Firebase(Constants.mymanagers);
        //f2=new Firebase(Constants.mydrivers);
        manageradapter=new ArrayAdapter<String>(
                ClientOrder.this,
                android.R.layout.select_dialog_singlechoice);
        f1.addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                manageradapter.add(Constants.convert2 (dataSnapshot.getKey()));
            }
            ...
            public void onChildRemoved(DataSnapshot dataSnapshot) {
                manageradapter.remove(dataSnapshot.getKey());
            }
        ...
        editext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(ClientOrder.this, date, myCalendar
...
//Time
        ...
        text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(ClientOrder.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
    ...
    public void fun(final View view){flag=0;
        switch (view.getId()){
            case R.id.managername:{
                AlertDialog.Builder builderSingle = new AlertDialog.Builder(ClientOrder.this);
                ...
                builderSingle.setAdapter(
                        ...
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                String strName = manageradapter.getItem(which);

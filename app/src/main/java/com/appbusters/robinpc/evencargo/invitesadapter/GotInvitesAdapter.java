 ...
 */
public class GotInvitesAdapter extends GotFirebaseListAdapter<InviteData> {

    // The mUsername for this client. We use this to indicate which messages originated from this user
    private String mUsername;

    public GotInvitesAdapter(Query ref, Activity activity, int layout, String mUsername) {

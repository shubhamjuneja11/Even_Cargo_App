...
import com.appbusters.robinpc.evencargo.orders.ClientOrder;
...
public class ClientPanelActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(ClientPanelActivity.this, ClientOrder.class);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new ActiveClientFragment(), "ACTIVE");
        adapter.addFrag(new PendingClientFragment(), "PENDING");
        adapter.addFrag(new CompletedClientFragment(), "COMPLETED");

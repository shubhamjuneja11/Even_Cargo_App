...
public class MyDriversActivity extends AppCompatActivity
    ...
    Firebase f,f2;
    public static ArrayList<String> arrayOfUsers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // f2=new Firebase(Constants.registered_users);
       /* listView=(ListView)findViewById(R.id.commonlistview);
        final ArrayAdapter adapter=new ArrayAdapter(this,R.layout.commonlayout);
...
// Attach the adapter to a ListView
                    ...
                    firebase.addChildEventListener(new ChildEventListener() {
                        ...
                        public void onChildAdded(DataSnapshot dataSnapshot, String s) {Log.e("aahat","hone ko h");
                            ...
                            if(dataSnapshot.getKey().equals("location")) {
                                ...
                                pl.add(new PersonLocation(finalKey, lat, lon, R.drawable.two));
                            }
                        }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent=new Intent(MyDriversActivity.this,DisplayDetails.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                PopupMenu popupMenu=new PopupMenu(MyDriversActivity.this,view);
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        switch (menuItem.getItemId()){
                            case R.id.viewlocation:{
                                Intent intent=new Intent(MyDriversActivity.this, DisplayLocation.class);
                                startActivity(intent);
                                break;
                            }
                            case R.id.notifyall:{
                                AlertDialog.Builder builder = new AlertDialog.Builder(MyDriversActivity.this);
                                builder.setTitle("Send group message:");
                                final EditText input = new EditText(MyDriversActivity.this);
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        {String m_Text = input.getText().toString();
                                            ...
                                            if(arrayOfUsers.size()!=0) {
                                                ...
                                                Toast.makeText(MyDriversActivity.this, "Sent to all", Toast.LENGTH_SHORT).show();
                                            }
                                            else
                                                Toast.makeText(MyDriversActivity.this, "No Drivers available", Toast.LENGTH_SHORT).show();

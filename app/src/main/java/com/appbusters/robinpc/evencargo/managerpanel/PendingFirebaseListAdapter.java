 ...
 */
public  class PendingFirebaseListAdapter<T> extends BaseAdapter {
    ...
    public PendingFirebaseListAdapter(Query mRef, Class<T> mModelClass, int mLayout, Activity activity) {
        this.mRef = mRef;
...
Log.e("is added","");
            // PendingManagerFragment.progressBar.setVisibility(View.VISIBLE);
                String key = dataSnapshot.getKey();//int c=0;
                T model = dataSnapshot.getValue(PendingFirebaseListAdapter.this.mModelClass);
                OrderClass orderClass=(OrderClass)model;
                if(orderClass.getmanager().equals(SigninActivity.myemail)&&(orderClass.getstatus()==0||orderClass.getstatus()==1)&&orderClass.m==1) {
                    Log.e("statuspending",String.valueOf(orderClass.getstatus()));
               ...
               /* mModels.add(model);
                ...
                //PendingManagerFragment.progressBar.setVisibility(View.GONE);
                }
            ...
            public void onChildChanged(DataSnapshot dataSnapshot, String s) {
              ...
              /*  String key = dataSnapshot.getKey();
                T newModel = dataSnapshot.getValue(PendingFirebaseListAdapter.this.mModelClass);
                OrderClass orderClass=(OrderClass)newModel;
                if(orderClass.getmanager().equals(SigninActivity.myemail)&&(orderClass.getstatus()==0||orderClass.getstatus()==1)) {
     ...
     */
    //protected abstract
    public void populateView(View v, T model){

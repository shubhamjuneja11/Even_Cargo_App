 ...
 */
public class ActiveFirebaseListAdapter<T> extends BaseAdapter {
    ...
    public ActiveFirebaseListAdapter(Query mRef, Class<T> mModelClass, int mLayout, Activity activity) {
        this.mRef = mRef;
...
Log.e("is added","");
                ...
                T model = dataSnapshot.getValue(ActiveFirebaseListAdapter.this.mModelClass);
                OrderClass orderClass=(OrderClass)model;
                if(orderClass.getmanager().equals(SigninActivity.myemail)&&(orderClass.getstatus()==2||orderClass.getstatus()==3)&&orderClass.getM()==1) {
            ...
            public void onChildRemoved(DataSnapshot dataSnapshot) {
                ...
                if (orderClass.getmanager().equals(SigninActivity.myemail) && (orderClass.getstatus() == 2 || orderClass.getstatus() == 3)&&orderClass.m==1) {
                    int index = mKeys.indexOf(key);
                    Log.e("hi", "3");
                    mKeys.remove(index);
